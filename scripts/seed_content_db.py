...
EGG_TYPES = [
    ...
    ("T-Rox",        28800,  "8h",      "images/eggs/t-rox_egg.png"),
    # ── Three-element (Natural Islands — 12h tier) ──
    ("Scups",        43200,  "12h",     "images/eggs/scups_egg.png"),
    ("Reedling",     43200,  "12h",     "images/eggs/reedling_egg.png"),
    ("Pummel",       43200,  "12h",     "images/eggs/pummel_egg.png"),
    ("Congle",       43200,  "12h",     "images/eggs/congle_egg.png"),
    ("Spunge",       43200,  "12h",     "images/eggs/spunge_egg.png"),
...
MONSTERS = [
    ...
    ("Glowl",        "amber",     "images/monsters/glowl.png",  "Glowl"),
    ("Flowah",       "amber",     "images/monsters/flowah.png", "Flowah"),
    ("Stogg",        "amber",     "images/monsters/stogg.png",  "Stogg"),
    ("Floogull",     "amber",     "images/monsters/floogull.png", "Floogull"),
    ("Barrb",        "amber",     "images/monsters/barrb.png",  "Barrb"),
    ("Repatillo",    "amber",     "images/monsters/repatillo.png", "Repatillo"),
    ("Tring",        "amber",     "images/monsters/tring.png",  "Tring"),
    ("Bisonorus",    "amber",     "images/monsters/bisonorus.png", "Bisonorus"),
    ("Boskus",       "amber",     "images/monsters/boskus.png", "Boskus"),
    ("Bowhead",      "amber",     "images/monsters/bowhead.png", "Bowhead"),
    ("Candelavra",   "amber",     "images/monsters/candelavra.png", "Candelavra"),
    ("Drummidary",   "amber",     "images/monsters/drummidary.png", "Drummidary"),
    ("Edamimi",      "amber",     "images/monsters/edamimi.png", "Edamimi"),
    ("Flum Ox",      "amber",     "images/monsters/flum-ox.png", "Flum_Ox"),
    ("Gnarls",       "amber",     "images/monsters/gnarls.png", "Gnarls"),
    ("Incisaur",     "amber",     "images/monsters/incisaur.png", "Incisaur"),
    ("Krillby",      "amber",     "images/monsters/krillby.png", "Krillby"),
    ("Phangler",     "amber",     "images/monsters/phangler.png", "Phangler"),
    ("PongPing",     "amber",     "images/monsters/pongping.png", "PongPing"),
    ("Rootitoot",    "amber",     "images/monsters/rootitoot.png", "Rootitoot"),
    ("Sneyser",      "amber",     "images/monsters/sneyser.png", "Sneyser"),
    ("Sooza",        "amber",     "images/monsters/sooza.png",  "Sooza"),
    ("Thrumble",     "amber",     "images/monsters/thrumble.png", "Thrumble"),
    ("Tiawa",        "amber",     "images/monsters/tiawa.png",  "Tiawa"),
    ("Tuskski",      "amber",     "images/monsters/tuskski.png", "Tuskski"),
    ("Viveine",      "amber",     "images/monsters/viveine.png", "Viveine"),
    ("Whaddle",      "amber",     "images/monsters/whaddle.png", "Whaddle"),
    ("Woolabee",     "amber",     "images/monsters/woolabee.png", "Woolabee"),
    ("Wynq",         "amber",     "images/monsters/wynq.png",   "Wynq"),
    ("Yelmut",       "amber",     "images/monsters/yelmut.png", "Yelmut"),
    ("Ziggurab",     "amber",     "images/monsters/ziggurab.png", "Ziggurab"),
]
